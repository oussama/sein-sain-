...
<?php 		include 'mesFunctionsSQL.php';
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $user['addresse'] ?></td>
                                            <td>
                                                <a href="createUpdate.php?id=<?php echo $user['id']?>&ACTION=UPDATE" >EDIT</a>
                                                <a href="createUpdate.php?id=<?php echo $user['id']?>&ACTION=DELETE" >DELETE</a> 
                                            </td>
                                        </tr>
